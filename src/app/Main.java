...
public class Main extends JFrame {
    ...
    public void handleImageUrlInput() {
        ...
        try {
            ...
            paintcomponents.ImageElement element = new paintcomponents.ImageElement(img, new Point(50, 50), url, "Image");
    ...
    public void handleLocalImageInput() {
        ...
        if (chooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                paintcomponents.ImageElement element = new paintcomponents.ImageElement(img, new Point(50, 50), file.getAbsolutePath(), "Image");
                paintElements.add(0, element);
                updateToolboxLayerList();
                drawingPanel.repaint();
    ...
    private void loadRSInterfaceImage() {
        try {
            rsInterfaceImage = ImageIO.read(new File("src/imgs/aabc.png"));
        } catch (IOException e) {
    ...
    public void addPaintElement(PaintElement element, boolean addToUndoStack) {
        if (addToUndoStack) {
            UndoableAction action = new actions.AddElementAction(this, element, 0); // Pass index 0 as required by constructor
    ...
    public void deletePaintElement(int listIndexInToolbox) {
        if (listIndexInToolbox >= 0 && listIndexInToolbox < paintElements.size()) {
            ...
            UndoableAction action = new actions.DeleteElementAction(this, removedElement, listIndexInToolbox);
    ...
    public void updatePaintElementDisplayName(int listIndexInToolbox, String newDisplayName) {
        if (listIndexInToolbox >= 0 && listIndexInToolbox < paintElements.size()) {
            ...
            if (!oldDisplayName.equals(newDisplayName)) {
                UndoableAction action = new actions.ChangeDisplayNameAction(this, element, oldDisplayName, newDisplayName, listIndexInToolbox);
    ...
    public void moveLayerUp(int listIndexInToolbox) {
        if (listIndexInToolbox > 0 && listIndexInToolbox < paintElements.size()) {
            ...
            UndoableAction action = new actions.ReorderLayerAction(this, element, listIndexInToolbox - 1, listIndexInToolbox);
            addUndoableAction(action);
    ...
    public void clearPaintElements() {
        if (!paintElements.isEmpty()) {
            ...
            UndoableAction action = new actions.ClearAllAction(this, elementsCleared);
                ...
                public void mouseReleased(MouseEvent e) {
                    ...
                    if (newElement != null) {
                        if (toolboxFrame != null) {
                            ...
                            Point pos = newElement.getPosition();
                            setLastActionStatus("Drew " + newElement.getName().toLowerCase() + " - [" + uniqueDisplayName + " (" + pos.x + ", " + pos.y + ")]");
                        }
                    }
