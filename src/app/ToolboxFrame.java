...
public class ToolboxFrame extends JFrame {
    ...
    public ToolboxFrame(Main mainFrame) {
        ...
        // Tool buttons
        JToggleButton textTool = createToolButton("Text", "/imgs/ui/material-symbols--font-download-outline-sharp.png", ToolType.TEXT);
        JToggleButton rectTool = createToolButton("Rectangle", "/imgs/ui/material-symbols--rectangle-outline.png", ToolType.RECTANGLE);
        JToggleButton roundRectTool = createToolButton("Rounded Rectangle", "/imgs/ui/material-symbols--rectangle-outline-rounded.png", ToolType.ROUND_RECTANGLE);
        JToggleButton circleTool = createToolButton("Circle", "/imgs/ui/material-symbols--circle-outline.png", ToolType.CIRCLE);
        JToggleButton lineTool = createToolButton("Line", "/imgs/ui/material-symbols--line-end.png", ToolType.LINE);
        JToggleButton polygonTool = createToolButton("Polygon", "/imgs/ui/uil--polygon.png", ToolType.POLYGON);
        JToggleButton imageUrlTool = createToolButton("Image URL", "/imgs/ui/material-symbols--image.png", ToolType.IMAGE_URL);
        JToggleButton imageLocalTool = createToolButton("Local Image", "/imgs/ui/material-symbols-light--image-search.png", ToolType.IMAGE_LOCAL);
        JToggleButton moveTool = createToolButton("Move", "/imgs/ui/mdi--cursor-move.png", ToolType.MOVE);
